...
import org.zhiqsyr.framework.utils.excel.imp.jxl.dao.FileSaveDao;
...
public class FileStoreService implements InitializingBean {
	 ...
	 * 数据文件保存的目录
	 */
//	@Value("${excel.upload.savedir}")	excel.upload.savedir=d:/upload/zyhzs
	private String saveDir;
//	@Value("${excel.upload.subdir.pattern}")	excel.upload.subdir.pattern={reportType}/{yyyyMM}
