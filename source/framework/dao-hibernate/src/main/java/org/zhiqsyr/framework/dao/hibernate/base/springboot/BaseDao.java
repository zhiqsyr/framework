package org.zhiqsyr.framework.dao.hibernate.base.springboot;
...
import org.zhiqsyr.framework.model.page.springboot.Page;
import org.zhiqsyr.framework.utils.throwable.Assert;
import org.zhiqsyr.framework.utils.throwable.SystemException;
...
public class BaseDao {
	...
	public <T> T getByProperty(Class<T> entityClass, String propertyName, Object propertyValue) {
		...
		throw new SystemException(String.format("There are %d records of %s.%s = %s", result.size(), entityClass.getName(), propertyName, propertyValue));
	}
