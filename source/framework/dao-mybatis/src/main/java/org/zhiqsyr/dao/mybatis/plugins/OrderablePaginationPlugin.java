...
import org.zhiqsyr.dao.common.dialect.MySqlDialect;
import org.zhiqsyr.dao.common.dialect.OracleDialect;
import org.zhiqsyr.dao.common.dialect.SqlDialect;
import org.zhiqsyr.dao.common.dialect.SqlServerDialect;
import org.zhiqsyr.dao.mybatis.utils.ReflectUtils;
import org.zhiqsyr.dao.mybatis.utils.SqlUtils;
...
public class OrderablePaginationPlugin implements Interceptor {
	...
	public void setProperties(Properties p) {
		...
		if (dialect == null || dialect.trim().equals("")) {
			throw new RuntimeException("the properties dialect did not inject");
		} 
		...
		default:
			throw new IllegalArgumentException("the properties dialect is illegal");
		}
	}
